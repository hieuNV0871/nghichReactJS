  ...
  return (
    <div className="w-[692px] max-w-[692px] mx-4 pb-6 border-b border-b-[#e7e7e9]">
      ...
      <div className="flex py-5">
        <div className="flex-1 flex ">
          ...
          <div>
            ...
            <div>
              ...
              <p className="inline-block font-bold hover:underline">
                #xuhuong #hot #foryou
              </p>
            </div>
            <Link className="flex items-center">
              {props.data.music && <MusicNoteIcon />}
              <span className="ml-1 font-bold hover:underline">
                {props.data.music}
              </span>
            </Link>
          </div>
        ...
        <div>
          <button className="text-[#fe2c55] min-w-[88px] min-h-[28px] border border-[#fe2c55] font-semibold px-[10px] rounded select-none hover:bg-[#fe2c550f]">
            follow
          </button>
        </div>
      </div>
      ...
      <div className="flex pl-[70px] ">
        ...
        <div className="flex flex-col self-end ml-5">
          <button className="flex justify-center items-center flex-col">
            ...
            <span className="mt-1  mb-2 font-bold text-xs text-[#161823bf]">
